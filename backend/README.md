...
## Project Structure
    ...
    ├── testapiautoteammemb_62505  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammemb_62505`
...
2. Clone this repo and `cd testapiautoteammemb_62505`
